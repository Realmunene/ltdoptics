    ...
    <>
      ...
      {open && (
        <div className="fixed bottom-5 right-5 z-[9999] w-80 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden animate-fadeIn">
          {/* Header */}
          <div className="flex items-center justify-between bg-sky-400 text-white px-4 py-3">
          ...
          <div className="bg-gray-50 px-4 py-3">
            <div className="bg-white border rounded-lg p-3 shadow-sm max-w-[85%]">
              <p className="text-sm text-gray-800">
                Hi! 👋 Welcome to Blue Block Optics.
                How can we assist you today?
              </p>
              <p className="text-xs text-gray-400 mt-1 text-right">8:00</p>
            </div>
          </div>
          ...
          <div className="p-3">
            <a
              href="https://wa.me/+254723697616"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-sky-400 hover:bg-green-700 text-white font-medium w-full rounded-lg py-2 flex items-center justify-center space-x-2 transition"
            >
          ...
          <div className="text-[10px] text-center text-black-300 pb-2">
            Powered by <span className="text-sky-400 font-semibold">Blue Block Optics</span>
          </div>
        </div>
      )}

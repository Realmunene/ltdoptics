...
const glassesData = [
  {
    id: 1,
    name: "All types glasses and Frames",
    description:
      "Stylish, lightweight for everyday usage with modern gradient frame.",
    images: [img1],
  },
  {
    id: 2,
    name: "Casings",
    description:
      "That is soft, off-white microfiber cleaning cloth tailored for gentle lens maintenance.",
    images: [img2],
  },
  {
    id: 3,
    name: "Safety Glasses",
    description:
      "High-utility glasses that are highly customizable and typically come as a multi-lens kit designed for various activities",
    images: [img3],
  },
];
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <input
            type="text"
            placeholder="Search Eyewear accessories..."
            value={searchTerm}
            onChange={(e) => {
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 text-center">
        <p className="text-gray-600 text-lg leading-relaxed max-w-4xl mx-auto">
          Explore our premium range of eyewear accessories, thoughtfully designed to enhance the protection, comfort, and longevity of your glasses. From stylish cases and cleaning kits to durable chains, cords, and maintenance essentials, our collection offers the perfect blend of practicality, quality, and style for everyday use.
        </p>
      </section>
